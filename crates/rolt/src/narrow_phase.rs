...
/// See also: Jolt's [`NarrowPhaseQuery`](https://secondhalfgames.github.io/jolt-docs/5.0.0/class_narrow_phase_query.html) class.
pub struct NarrowPhaseQuery<'physics_system> {
    raw: *const JPC_NarrowPhaseQuery,
    _phantom: PhantomData<&'physics_system ()>,
}

/// See also: Jolt's [`RRayCast`](https://secondhalfgames.github.io/jolt-docs/5.0.0/struct_r_ray_cast.html) class.
